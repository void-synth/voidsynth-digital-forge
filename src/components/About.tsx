      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-slide-in-left">
            <div className="space-y-4">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Hey there! I'm <span className="text-primary font-semibold">Mufutau Umar Olamilekan</span>, 
                but the digital world knows me as <span className="text-accent font-semibold">VoidSynth</span>. 
            ...
            {/* Mission Statement */}
            <div className="bg-card/50 p-6 rounded-lg neon-border">
          ...
          <div className="space-y-6 animate-slide-in-right">
            ...
            <Card className="bg-gradient-to-br from-primary/10 to-accent/10 border-primary/20">
              <CardContent className="p-6 text-center">
                <div className="mb-4">
                  ...
                  <h3 className="text-xl font-bold text-primary">ALX Africa Graduate</h3>
            ...
            {/* Origin Story */}
            <Card className="bg-card/30 border-muted/20">
